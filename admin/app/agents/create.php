<?php
  ...
  if (isset($_POST['send'])) {
    ...
    $salary = $_POST['salary'];
    $create = "INSERT INTO `agents` VALUES (NULL,'$name','$email','$hashPassword','$phone','$address','$nid','$imageName',$salary,NULL)";
    $createRun = mysqli_query($connect, $create);
    redirect('agents/create.php');
    getMessage($createRun,'Agents is added');
  }
  clearSessionDone('agents/create.php');
?>
  ...
  <section class="section">
    <div class="row container">
      <div class="col-lg-9">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Create New Agent Form</h5>
