<?php 
  ...
  $select = "SELECT * FROM 'joindataproperities' WHERE propId = '$id'";
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              ...
              <span class="color-text-a"><?= $row['location']?></span>
            </div>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <img src="../admin/app/agents/upload/<? $row['agentImage']?>" alt="" class="img-fluid">
              </div>
              <div class="col-md-6 col-lg-4">
